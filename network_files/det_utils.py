...
class BoxCoder(object):
    ...
    def decode(self, rel_codes, boxes):
        ...
        Args:
            rel_codes: bbox regression parameters 预测的目标边界框的回归参数
            boxes: anchors/proposals的坐标
        ...
        boxes_per_image = [b.size(0) for b in boxes] # 每张图片的boxs获取数目
